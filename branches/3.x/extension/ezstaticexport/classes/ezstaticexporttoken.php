...
class eZStaticExportToken
{
    ...
    */
    function exists()
    {
        $count = eZStaticExportExport::fetchCountByStatus( array( EZ_STATIC_EXPORT_STATUS_PENDING,
                                                                  EZ_STATIC_EXPORT_STATUS_RUNNING,
                                                                  EZ_STATIC_EXPORT_STATUS_INTERRUPTED ) );
        return ( $count > 0 );
    }
    ...
    */
    function isPending()
    {
        $count = eZStaticExportExport::fetchCountByStatus( array( EZ_STATIC_EXPORT_STATUS_PENDING, EZ_STATIC_EXPORT_STATUS_INTERRUPTED ) );
        return ( $count > 0 );
    }
    ...
    */
    function isRunning()
    {
        $count = eZStaticExportExport::fetchCountByStatus( array( EZ_STATIC_EXPORT_STATUS_RUNNING ) );
        return ( $count > 0 );
    }

    function isInterrupted()
    {
        $count = eZStaticExportExport::fetchCountByStatus( array( EZ_STATIC_EXPORT_STATUS_INTERRUPTED ) );
        return ( $count > 0 );
    }
}
