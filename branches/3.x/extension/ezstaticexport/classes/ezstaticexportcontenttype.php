...
class eZStaticExportContentType extends eZPersistentObject
{
    ...
    */
    function fetchByNodePathString( $pathString, $recurse = true )
    {
    ...
    */
    function flag( $flagType, $nodeID, $contentType )
    {
    ...
    */
    function isDefaultContentType( $contentType)
    {
    ...
    */
    function &getNodesCount()
    {
        ...
        elseif ( $this->attribute( 'flag_type' ) == 'subtree' )
        {
            $node = $this->getNode();
            $array = array();
            $count = eZContentObjectTreeNode::subTreeCount( $array, $node->attribute( 'node_id' ) );
